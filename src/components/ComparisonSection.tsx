...
export default function ComparisonSection() {
  return (
    <section id="comparador" className="py-12 sm:py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-blue-200 shadow-lg">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-700 font-bold text-sm">Análisis con IA</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-700 font-bold text-sm">Tiempo real</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-700 font-bold text-sm">Asesoramiento</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-700 font-bold text-sm">Gestión completa</span>
                </div>
              </div>
